...
class FactionPicking(Process, status=MatchStatus.IS_FACTION):
    def __init__(self, match, *isjoining, is1v1=False, isTraining=False):
        self.match = match
        self.is1v1 = is1v1
        ...
        if not isjoining or isjoining is None:
