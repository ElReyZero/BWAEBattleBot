...
class Player:
    ...
    def __init__(self, p_id, name, discriminator="N/A"):
    ...
    def new_from_data(cls, data):  # make a new Player object from database data
        ...
        obj.__discriminator = data["discriminator"]
    ...
    def get_data(self):  # get data for database push
        data = {"_id": self.__id, "name": self.__name,"discriminator": self.__discriminator, "notify": self.__notify, "is_registered": self.__is_registered}
        if self.__has_own_account:
...
class ActivePlayer:
    ...
    @property
    def discriminator(self):
        return self.__player.discriminator
